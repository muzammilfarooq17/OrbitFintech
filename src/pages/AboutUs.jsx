...
import cardBlackAbout from '../assets/images/Card 1 (1).png';
import cardPurpleAbout from '../assets/images/Card 2.png';
...
const AboutUs = () => {
  ...
  return (
    <div className="w-full flex flex-col min-h-screen pt-0">
      ...
      <motion.section 
        ...
        className="min-h-[90vh] w-full flex items-center justify-between gap-12 pt-2 pb-3 select-none max-w-7xl mx-auto px-4 relative"
      >
        {/* LEFT SIDE */}
        ...
        {/* RIGHT SIDE: CARDS */}
        <div className="w-[45%] relative h-[600px] flex items-center justify-center">
          <div className="absolute w-[720px] z-20 top-[90px] -right-6 drop-shadow-[-10px_20px_25px_rgba(0,0,0,0.5)]">
            <img 
              src={cardPurpleAbout} 
          ...
          <div className="absolute w-[680px] z-10 top-[-200px] -right-5 drop-shadow-[-25px_25px_40px_rgba(0,0,0,0.75)]">
            <img 
              src={cardBlackAbout} 
